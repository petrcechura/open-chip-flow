            ...
            case (state)
                ...
                IDLE: begin
    				...
    				if (reset_evt.triggered) begin
                        automatic i2c_seq_item i2c_item = i2c_seq_item::type_id::create("seq_item");
    					seq_item.data = '{1'bX};
    					ap.write(seq_item);
    				end
                ...
                SAMPLE: begin
                    ...
                    if (reset_evt.triggered) begin
                        ...
                        automatic i2c_seq_item seq_item = i2c_seq_item::type_id::create("seq_item");
                        seq_item.stopbit = 1'b1;
                        ap.write(seq_item);
